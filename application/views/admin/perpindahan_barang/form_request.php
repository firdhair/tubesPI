          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="name" style="margin-left:220px;display:inline;">Ditujukan Untuk</label>
                  <input type="text" name="name" style="margin-left:117px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->name?>">
                </div>
