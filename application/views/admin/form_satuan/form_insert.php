      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box" style="width:94%;" id="box_forms">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=site_url('admin/proses_satuan_insert')?>" role="form" method="post">
            ...
            <?php } ?>
              ...
              <div class="box-footer" style="width:93%;">
                ...
                <a type="button" id="button3" class="btn btn-info" style="width:13%;margin-right:29%" href="<?=site_url('admin/tabel_satuan')?>" name="btn_listsatuan"><i class="fa fa-table" aria-hidden="true"></i> Lihat Satuan</a>
